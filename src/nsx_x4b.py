...
basis (grams from nsx_x4_grams.npz). Memory-ordered to stay under ~1.8 GB.
...
for cut in (1e-10, 1e-12):
    ...
    Ats[cut] = At
np.savez('nsx_x4_prep.npz', Gt=Gt, At_10=Ats[1e-10], At_12=Ats[1e-12])
log("saved nsx_x4_prep.npz")
